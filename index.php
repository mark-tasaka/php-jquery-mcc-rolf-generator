...
<html>
<head>
<title>Launch Page: Rolf Character Generator</title>
...
<body>
	...
	<section>
        ...
        <br/>
            ...
            <br/>    
			<form action="" id ="rolfForm"  target="_blank" method="post">
		...
		<div class="content8">
			  ...
			  <select id="level" class="dropdownmenu2Iconic">
				<option value="01" selected>Rolf, Level 1</option>
				<option value="02">Rolf, Level 2</option>
				<option value="03">Rolf, Level 3</option>
				<option value="04">Rolf, Level 4</option>
				<option value="05">Rolf, Level 5</option>
				<option value="06">Rolf, Level 6</option>
				<option value="07">Rolf, Level 7</option>
				<option value="08">Rolf, Level 8</option>
				<option value="09">Rolf, Level 9</option>
				<option value="10">Rolf, Level 10</option>
			  </select>
        ...
        {
            $("#rolfForm").attr('action', "rolf/rolf"+ $("#level").val() +  ".php");
        });
